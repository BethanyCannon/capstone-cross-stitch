    //https://www.svgrepo.com/svg/335228/heart-solid
function Like({ color, stroke }) {

    return (
        <svg fill={color} stroke={stroke} width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
